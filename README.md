...
```
80.0;25.0;15.0;1;true;false;190;150;110;ExampleName;true;16;1;1;1;8;8;2;0;8
```
...
6. Use the **Save QR Code** button to save the QR code as an image.
7. Use the **Copy QR Code** button to copy the QR code to the clipboard.
...
- **QR Code Section**: Displays the generated QR code with options to save or copy it.
